...
class AIForecastObservations(Base):
    ...
    obs_type: 'forecast' (revenue/forecast focus) or 'pipeline' (stage/tier/velocity focus)."""
    ...
    obs_type = Column(String(16), nullable=False, default="forecast")  # 'forecast' | 'pipeline'
