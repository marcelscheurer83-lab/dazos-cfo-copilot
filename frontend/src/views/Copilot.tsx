  ...
  return (
    <>
      ...
      <p style={{ color: 'var(--text-muted)', marginBottom: '1.5rem', maxWidth: 560 }}>
        Ask questions in plain English: runway, cash balance, burn rate, revenue growth, gross margin, EBITDA, AR/AP days.
      </p>
      <div
        style={{
        ...
        <div style={{ flex: 1, overflow: 'auto', padding: '1rem' }}>
          {messages.length === 0 && (
            <div style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>
              Try: &ldquo;What is our runway?&rdquo; or &ldquo;How did revenue compare to last year?&rdquo;
            </div>
          )}
          {messages.map((msg, i) => (
            <div
